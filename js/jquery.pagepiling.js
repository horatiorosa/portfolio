...
tip(function ($, document, window, undefined) {
    'use strict';
    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        PP.moveSectionUp = function () {
            ...
            //looping to the bottom if there are no more sections above
        ...
        */
        PP.moveSectionDown = function () {
            ...
            //looping to the top if there are no more sections below
        ...
        */
        ...
        /**
        * Scrolls the site without animations (usually used in the background without the user noticing it)
        */
