import { wait, app } from '../utils/selectors.js';
...
export async function animateTitle() {
  ...
  const titles = [
    {
      title: 'Dog Dad',
      image: '/images/horatio_jiro_family_portrait.jpg',
      alt: 'man and his dog posed in a family style photo',
    },
    {
      title: 'Volleyball Player',
      image: '/images/volleyball_team_lets_go.jpg',
      alt: 'men and women of a volleyball team in a huddle',
    },
